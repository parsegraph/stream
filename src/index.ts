...
export default class Room {
  ...
  load(items:any)
  {
      ...
      var car = new BlockCaret(this._root);
      car.spawnMove('d', 'u', 'c');
  ...
  pushListItem(id:string|number, type:string, value:any, cb?:Function, cbThisArg?:object)
  {
      this.request({
  ...
  editListItem(id:string|number, value:any, cb?:Function, cbThisArg?:object)
  {
      this.request({
          command:"editItem",
          item_id:id,
